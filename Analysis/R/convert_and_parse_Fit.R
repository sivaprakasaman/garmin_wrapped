...
data_dir <- "~/Documents/Code/garmin_wrapped/DEMO_Data/fit_data"; #Folder with all your fit files
out_dir <- "~/Documents/Code/garmin_wrapped/DEMO_Data/fit_convert"; #Where you want the converted csv files to live
